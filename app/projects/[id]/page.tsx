...
import {getAllTasksByProjectId, getTask} from "@/app/services/taskService"
...
function GanttChart({ tasks, onTaskClick }: { tasks: any[], onTaskClick?: (task: any) => void }) { {
    ...
    const ganttData = tasks.map(task => {
        ...
        return {
            ...
            originalTask: task  // ← THÊM DÒNG NÀY
        }
    })
